...
export const fr = {
  ...
  'checkout.fieldLocalite': 'Zone (quartier)',
  'checkout.localitePlaceholder': 'Recherchez votre quartier (ex. Ouakam)',
  ...
  'checkout.fieldAddress': 'Adresse complète',
  'checkout.addressPlaceholder': 'Rue, immeuble, étage, point de repère',
  ...
  'checkout.errorZoneApi': 'Choisissez votre zone dans la liste',
  'checkout.localiteNoMatch': 'Aucune zone trouvée : choisissez le quartier le plus proche, puis précisez votre adresse complète.',
  'checkout.localiteChange': 'Changer de zone',
  ...
  'suivi.deliveringTo': 'Livraison à {commune}',
