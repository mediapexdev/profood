...
const ShopIcon: React.FC = () => {
    ...
    return (
        <>
            {/* begin::Svg Icon | path: www/preview.keenthemes.com/kt-products/docs/metronic/html/releases/2023-03-24-172858/core/html/src/media/icons/duotune/ecommerce/ecm004.svg */}
            <svg
                width="24"
                height="24"
                viewBox="0 0 24 24"
