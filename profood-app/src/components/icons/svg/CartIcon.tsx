...
const CartIcon: React.FC = () => {
    ...
    return (
        <>
            {/* begin::Svg Icon | path: www/preview.keenthemes.com/kt-products/docs/metronic/html/releases/2023-01-30-131017/core/html/src/media/icons/duotune/ecommerce/ecm001.svg */}
            <svg
                width="24"
                height="24"
                viewBox="0 0 24 24"
