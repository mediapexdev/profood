 ...
 * @returns 
 */
const CategoryDeleteModal: React.FC<CategoryDeleteModalProps> = ({category, show, setShow, toggle, onClosed}: CategoryDeleteModalProps) => {
    /**
     * 
     */
