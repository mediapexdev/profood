...
import NewUserFormView from "../users/components/NewUserFormView";

import './NewLivreurPageContent.css';

const LIVREUR_ROLE_CODE = 4;

const NewLivreurPageContent: React.FC = () => {
    const { t } = useTranslation();
    const goTo = useGoTo();

    return (
        <div
            id="newLivreurPageContent"
...
export default NewLivreurPageContent;
