...
import './UserPasswordEditingFormView.css';
 ...
 * @returns 
 */
const UserPasswordEditingFormView: React.FC<UserProps> = (user: UserProps) => {
    /**
     * 
     */
    ...
    const update = () => {
        ...
        api.post('/update-user-password-by-admin', data,
            {
                headers: {
    ...
    return (
        <Card
            id="userPasswordEditingFormView"
            className="border-0"
        >
...
export default UserPasswordEditingFormView;
