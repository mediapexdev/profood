 ...
 * @returns 
 */
const ProductDeleteModal: React.FC<ProductDeleteModalProps> = ({product, show, setShow, toggle, onClosed}: ProductDeleteModalProps) => {
    /**
     * 
     */
     ...
     * 
     */
    const { fetchSlices } = useDataContext();
