...
import NewCustomerFormView from "./components/NewCustomerFormView";

import './NewCustomerPageContent.css';

/**
 * 
 * @returns 
 */
const NewCustomerPageContent: React.FC = () => {
    /**
     * 
     */
...
export default NewCustomerPageContent;
