...
import './CustomerDeleteModal.css';
 ...
 * @returns 
 */
const CustomerDeleteModal: React.FC<CustomerDeleteModalProps> = ({customer, show, setShow, toggle, onClosed}: CustomerDeleteModalProps) => {
    /**
     * 
     */
