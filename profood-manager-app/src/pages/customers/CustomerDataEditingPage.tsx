...
import CustomerDataEditingPageContent from "./CustomerDataEditingPageContent";
import Toast from "../../components/widgets/Toast";
import { CustomerProps } from "../../types";
import { useDataContext } from "../../components/contexts/DataProvider";

import './CustomerDataEditingPage.css';

/**
 * 
 * @returns 
 */
const CustomerDataEditingPage: React.FC = () => {
    /**
     * 
     */
    ...
    return (
        ...
        >
            ...
            <Header>
                ...
                <div className="page-title-box d-flex align-items-center px-5 px-sm-8 px-xl-10 px-xxl-12 border-top">
                    <div className="d-flex flex-stack w-100">
                        <h2 className="mb-0 fs-7">{`${t('Clients')} - ${t('Edition')}`}</h2>
                        <div className="page-title-right">
                            <ol className="breadcrumb m-0">
                                ...
                                <li className="breadcrumb-item text-gray-700 active">{t('Edition')}</li>
                            </ol>
                        </div>
                    </div>
                </div>
            ...
            {/* begin::page layout */}
            <div
                id="customerDataEditingPageContainer"
                className="page-container position-relative d-flex flex-column"
            >
            { customer && <CustomerDataEditingPageContent {...customer} /> }
            </div>
            {/* end::page layout */}
            {/* begin::footer */}
            <Footer />
...
export default CustomerDataEditingPage;
